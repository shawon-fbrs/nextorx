...
const OTC_PAIRS = [
  { id: "EURUSD", name: "EUR/USD", category: "forex", basePrice: 1.0850, volatility: 0.0080, payoutPercent: 80, sortOrder: 1 },
  { id: "GBPUSD", name: "GBP/USD", category: "forex", basePrice: 1.2700, volatility: 0.0100, payoutPercent: 77, sortOrder: 2 },
  { id: "USDJPY", name: "USD/JPY", category: "forex", basePrice: 149.50, volatility: 1.20, payoutPercent: 86, sortOrder: 3 },
  { id: "EURGBP", name: "EUR/GBP", category: "forex", basePrice: 0.8540, volatility: 0.0060, payoutPercent: 80, sortOrder: 4 },
  { id: "USDINR", name: "USD/INR", category: "forex", basePrice: 83.20, volatility: 0.80, payoutPercent: 82, sortOrder: 5 },
  { id: "USDBDT", name: "USD/BDT", category: "forex", basePrice: 117.50, volatility: 1.50, payoutPercent: 80, sortOrder: 6 },
  { id: "USDPKR", name: "USD/PKR", category: "forex", basePrice: 278.00, volatility: 3.00, payoutPercent: 80, sortOrder: 7 },
  { id: "USDNPR", name: "USD/NPR", category: "forex", basePrice: 133.50, volatility: 1.50, payoutPercent: 78, sortOrder: 8 },
  { id: "EURJPY", name: "EUR/JPY", category: "forex", basePrice: 162.30, volatility: 1.50, payoutPercent: 80, sortOrder: 9 },
  { id: "GBPJPY", name: "GBP/JPY", category: "forex", basePrice: 190.00, volatility: 1.80, payoutPercent: 84, sortOrder: 10 },
