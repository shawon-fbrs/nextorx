...
// Launch set: 6 synthetic OTC pairs. All prices are generated by the
// provably-fair engine from the daily seed, starting at basePrice.
// No external market feed is used.
const OTC_PAIRS = [
  ...
  { id: "VOLX", name: "Volatility 100", symbol: "VOLX/USD", category: "crypto", feed: "synthetic", basePrice: 1000.00, volatility: 2.20, payoutPercent: 85, weekendPayout: 85, spread: 0.05, tags: ["synthetic", "volatile"], sortOrder: 6 },
];
