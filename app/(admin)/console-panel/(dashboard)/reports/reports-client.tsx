...
type Pnl = {
  totals: { gross: number; stakesKept: number; payouts: number; volume: number; trades: number };
  byPair: { pairId: string; pairName: string; trades: number; volume: number; gross: number }[];
} | null;

type Exposure = { pairId: string; pairName: string; up: number; down: number; net: number; total: number; count: number }[] | null;
...
export default function ReportsClient({
  ...
  const pnl = initialPnl;
  const exposure = initialExposure;
