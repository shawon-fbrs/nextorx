...
export default function OperationsClient({ initialStats }: { initialStats: Stats }) {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          {[1, 2, 3, 4].map((i) => <div key={i} className="bg-surface border border-border rounded-xl p-4 space-y-2"><div className="h-3 w-24 bg-border rounded" /><div className="h-6 w-20 bg-border rounded" /></div>)}
        </div>
      </div>
    );
  }
