    ...
    <div className="min-h-screen bg-background text-text px-6 py-12">
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="space-y-4 text-sm text-text leading-relaxed">
          <section>
            <h2 className="text-base font-bold text-foreground mb-1">1. Data we collect</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-foreground mb-1">2. How we use it</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-foreground mb-1">3. Document storage</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-foreground mb-1">4. Retention</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-foreground mb-1">5. Your rights</h2>
          ...
          <section>
            <h2 className="text-base font-bold text-foreground mb-1">6. Cookies</h2>
